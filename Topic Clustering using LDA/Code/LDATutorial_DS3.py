...
trainDocs=trainDocs[0:185]
testDocs=trainLyricsFile['lyrics'][185:]
...
plt.plot(Bplot)
plt.savefig('Plots/lyrics_convergence')
plt.show()
...
dataframe.to_csv('Plots/leanedTopicds3.csv', encoding='utf-8', index=True)
...
# for d in range(dStart,dEnd):
    ...
    print("_______________________")
    print('True Mood is:',trainGT[185+d])
    print("_______________________")
